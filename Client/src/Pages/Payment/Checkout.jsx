            ...
            >
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                    ...
                    <div className="px-4 space-y-5 text-center">
                        ...
                        <button type="submit" className="bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 absolute bottom-1 w-full left-0 text-xl font-bold rounded-bl-lg rounded-br-lg py-3">
                            Buy now
                        </button>
                    </div>
                </div>
